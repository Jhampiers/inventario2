...
$institucion = $_POST['busqueda_tabla_insti'] ?? '';

// Conexión DB
$conexion = Conexion::connect();

// Consulta SQL con filtros
$sql = "SELECT id, beneficiario, cod_modular, ruc, nombre FROM institucion
        WHERE cod_modular LIKE '$codigo%' AND ruc LIKE '$ruc%' AND nombre LIKE '$institucion%'
        ORDER BY id ASC";
$resultado = $conexion->query($sql);

// Contenido HTML del PDF
$contenido_pdf = '
<h1 style="text-align: center; font-size:14px;">REPORTE DE INSTITUCIONES</h1>
