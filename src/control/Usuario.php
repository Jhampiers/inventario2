...
try {
    ...
    $mail->Username   = 'yampiersquispe@programacion2024.com';                     //SMTP username
    $mail->Password   = '13579Inventario';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('yampiersquispe@programacion2024.com', 'Cambio de contraseña');
